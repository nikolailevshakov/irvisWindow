...
/* harmony import */ var _checkNumbInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumbInputs */ "./src/js/modules/checkNumbInputs.js");
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumbInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_checkNumbInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
...
var checkNumbInputs = function checkNumbInputs(selector) {
  var numbInputs = document.querySelectorAll(selector);
  numbInputs.forEach(function (item) {
...
/* harmony import */ var _checkNumbInputs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNumbInputs */ "./src/js/modules/checkNumbInputs.js");
...
var forms = function forms(state) {
  ...
  Object(_checkNumbInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка...',
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.querySelector('.status').textContent = message.loading; // fetch api
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(statusMessage); // Для запроса
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    modal.addEventListener('click', function (e) {
      ...
      if (e.target === modal && closeClickOverlay) {
        modal.style.display = 'none';
        document.body.style.overflow = 'initial'; // используем классы bootstrap для того же 
